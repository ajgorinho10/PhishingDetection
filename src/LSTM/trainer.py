...
class EarlyStopping:
    def __init__(self, patience=2, min_delta=0.001, path=cfg.PATH):
...
class Trainer:
    ...
    def __init__(self, model, data_sets = None):
        self.model = model
    ...
    def get_data_loaders(self, X_data, y_data, shuffled = False):
        ...
        dataloader = DataLoader(dataset, batch_size=cfg.BATCH_SIZE, shuffle = shuffled)
